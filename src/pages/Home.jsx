...
const Home = () => {
  ...
  const skillsData = {
    frontend: [{ name: 'React', level: 90 }, { name: 'Tailwind', level: 95 }, { name: 'MUI', level: 85 }],
    backend: [{ name: 'Node.js', level: 75 }, { name: 'MongoDB', level: 70 }],
    tools: [{ name: 'Vite', level: 95 }, { name: 'Git', level: 85 }]
  };

  const projects = [
    { id: 1, title: 'Society Management', category: 'Web App', img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500' },
    { id: 2, title: 'Wok N Grill Xpress', category: 'Restaurant', img: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500' },
  ];
    ...
    <div className="lg:space-y-32 space-y-18 lg:pb-20 pb-10  dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section className="lg:min-h-[80vh] flex flex-col justify-center items-center text-center px-6">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mb-10">
          Senior Frontend Developer specializing in React and the OpenClaw AI aesthetic. 
          Turning complex code into soft-gradient experiences.
        </p>
        <div className="flex space-x-4">
          <button className="bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 px-8 py-4 rounded-2xl font-bold flex items-center hover:bg-slate-800 dark:hover:bg-slate-200 transition-all">
